This is the hello world project written in C.

This project is the first C project as part of the ALX Africa SE curriculum, and covers the very basics of compilation and C.
